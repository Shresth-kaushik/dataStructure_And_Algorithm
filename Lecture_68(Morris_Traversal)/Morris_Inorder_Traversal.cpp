// Morris (InOrder) traversal is a tree traversal algorithm that 
// does not employ the use of recursion or a stack. In this traversal, 
...
void morrisTraversalPreorder(node* root)
{
	while (root)
	{
		...
		else
		{
			...
			// current->right !=root is the condition to check if the loop exist or not : 
